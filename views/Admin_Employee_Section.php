...
<head>
    ...
    <script src="../js/getEmployees.js" defer></script>
    <script src="../js/removeEmployee.js" defer></script>
                ...
                <footer class="content-footer footer bg-footer-theme">
                    <div class="employeers_section">
                        <section style="flex: inline-block;;justify-content: space-between;">
                            ...
                            <button id="Add_employee" class="Add_employee" onclick="" >Add Employee</button>
                            <button id="Remove_employee" class="Remove_employee" onclick="" >Remove Employee</button>
                            <button id="Cancel_employee" class="Cancel_employee" onclick="" >Cancel</button>
                            <button id="Archive_Employee" class="Archive_Employee" onclick="" >Show All</button>
