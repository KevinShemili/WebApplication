...
<head>
    ...
    <script src="../js/viewEmployee.js" defer></script>
...
<body>
            ...
            <div class="card-body">
                <div class="row">
                  <div class="mb-3 col-md-6">
                    ...
                    <input class="form-control" type="text" id="name" name="name" placeholder="John" autofocus />
                  </div>
                  <div class="mb-3 col-md-6">
                    <label for="surname" class="form-label">Surname</label>
                    <input class="form-control" type="text" id="surname" name="surname" placeholder="Doe" require />
                  </div>
                  <div class="mb-3 col-md-6">
                    <label for="email" class="form-label">Email</label>
                    <input class="form-control" type="text" id="email" name="email" placeholder="john.doe@example.com" require />
                  </div>
                  <div class="mb-3 col-md-6">
                    <label for="username" class="form-label">Username</label>
                    <input class="form-control" type="text" id="username" name="username" placeholder="johnDoe" require />
                  </div>
                  <div class="mb-3 col-md-6">
                    <label for="password" class="form-label">Password</label>
                    <input class="form-control" type="password" id="password" name="password" placeholder="********"  require/>
                  </div>
                  <div class="mb-3 col-md-6">
                ...
                <div class="mt-2">
                  <button type="submit" id="confirm" class="btn btn-primary me-2">Confirm</button>
    ...
    <script>  document.getElementById('cancel').addEventListener('click', function() {
        window.location.href = 'Admin_Employee_Section.php';
        });</script>
